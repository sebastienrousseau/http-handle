//! # SSG Server
//!
//! `http-handle` is a simple and efficient HTTP server for serving static websites generated by the Shokunin Static Site Generator (SSG). It handles HTTP requests and responses, manages server operations, and provides robust error handling.
//!
//! ## Modules
